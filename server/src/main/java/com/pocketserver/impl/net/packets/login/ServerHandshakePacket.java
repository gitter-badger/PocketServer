...
public class ServerHandshakePacket extends OutPacket {
	...
	// Hypixel: 84 00 00 00 40 02 F0 01 00 00 10 04 80 FF FF FE 4A BC 04 80 FF FF FE 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 00 00 00 00 00 69 97 2C 00 00 39 D3 DA D4 46 CB
	// Ours   : 84 00 00 00 40 02 F0 01 00 5E 10 04 80 FF FF FE 4A BC 04 80 FF FF FE 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 04 FF FF FF FF 4A BC 00 00 00 00 00 69 97 2C 00 00 01 50 C8 BB 32 F4
